...
@section('main-content')
    <div class="col-lg-5 mx-auto">
        <form class="row g-3" method="post" action="/apartment/update">
    ...
    <script>
        ...
        $("input[name=title]").val(apartment['title'])
        $("input[name=type]").val(apartment['type'])
        $("input[name=price]").val(apartment['price'])
        JSON.parse(apartment['property']).forEach(i => {
